...
def main(argv):
    ...
    test_dir = argv[3]
    #run_dir = argv[2]
    csv_dir = "../data/logs/p_test/dummy"
    ...
    csv_path = csv_dir + "/cosine_"+ "obstacle" + ".csv"
    ...
    lst = pd.read_csv(csv_path)
    #print(lst.sort_values("cosine_color", ascending=False))
    print("------------------------------------------")
    print(lst["cosine_det_img"].sort_values(ascending=False))
    print("------------------------------------------")
    print(lst["cosine_seg_img"].sort_values(ascending=False))
    print("------------------------------------------")
    print(lst["cosine_det_dedge"].sort_values(ascending=False))
    print("------------------------------------------")
    print(lst["cosine_seg_dedge"].sort_values(ascending=False))
    print("------------------------------------------")
    print(lst["cosine_ip_img"].sort_values(ascending=False))
    print("------------------------------------------")
    print(lst["cosine_ip_dedge"].sort_values(ascending=False))
    print("------------------------------------------")
    print("predicted value : ", obstacle_res0, " ", obstacle_res1)
